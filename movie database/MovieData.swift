...
func searchActorName(actorSearchName: String, actorColumn: Int, completion: (alertString: String, success: Bool) -> Void){
        ...
        if let urlContent = data {
            ...
            do {
                ...
                if jsonResult.objectForKey("results")!.count > 1 {
                    ...
                    completion(alertString: "We found no matches. Please check that you spelled the name right.", success: false)
